 ...
 *  判断经纬度是否超出中国境内
 */
function isLocationOutOfChina(latitude: number, longitude: number): boolean {
...
function transformLatWithXY(x: number, y: number): number {
  var pi = 3.14159265358979324;
...
function transformLonWithXY(x: number, y: number): number {
  var pi = 3.14159265358979324;
